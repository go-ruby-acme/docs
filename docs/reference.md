...
The public API lives at the module root (`github.com/go-ruby-acme/acme`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `acme`, while the surface follows
...
- **[pkg.go.dev/github.com/go-ruby-acme/acme](https://pkg.go.dev/github.com/go-ruby-acme/acme)**

The module's [README](https://github.com/go-ruby-acme/acme#readme) carries worked
